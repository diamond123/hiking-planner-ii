...
class ExtractedSlots(BaseModel):
    ...
    location_text: str | None = Field(default=None, description="A place name or area the user wants to hike near (e.g. 'Berkeley', 'near Mount Diablo'). Null if not mentioned.")
